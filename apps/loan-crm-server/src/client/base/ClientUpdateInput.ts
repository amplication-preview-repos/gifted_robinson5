...
class ClientUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ApplicationUpdateManyWithoutClientsInput,
  })
  @ValidateNested()
  @Type(() => ApplicationUpdateManyWithoutClientsInput)
  @IsOptional()
  @Field(() => ApplicationUpdateManyWithoutClientsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LoanUpdateManyWithoutClientsInput,
  })
  @ValidateNested()
  @Type(() => LoanUpdateManyWithoutClientsInput)
  @IsOptional()
  @Field(() => LoanUpdateManyWithoutClientsInput, {
    nullable: true,
  })
